...
import static com.ramadan.remember.activity.MainActivity.collectionReference;

public class new_written_note extends AppCompatActivity {
    static int i1 = -13553359;
    TextView noteDate;
    EditText noteName, noteData;
    writtenNote _writtenNote;
    String key;
    RelativeLayout layout;
    ColorSlider noteColor, fontColor;
    FloatingActionButton noteColorBt, fontColorBt, deleteNote, saveNote;
    FloatingActionsMenu editNote;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_written_note);
